...
def create_app() -> FastAPI:
    ...
    from castor_server.api.management import router as management_router
    from castor_server.api.memory import router as memory_router
    ...
    app.include_router(memory_router, dependencies=auth_deps)
    app.include_router(openai_router, dependencies=auth_deps)
    app.include_router(management_router, dependencies=auth_deps)
